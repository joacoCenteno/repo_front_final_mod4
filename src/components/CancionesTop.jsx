  ...
  return (
    <>
        <div className='flex flex-col w-1/2 pt-6'>
            <h1 className='mb-5 text-2xl font-bold'>Top Canciones</h1>
                ...
                return(
                    ...
                    >
                        ...
                        <div className='flex gap-4 justify-between items-center'>
                            <p className='text-[#5c6b8a] group-hover:text-white'>{formatTime(cancion.duracion)}</p>
                            <i className="bi bi-heart-fill text-lg text-[#5c6b8a] group-hover:text-white"></i>
                            <i className="bi bi-plus-circle text-lg text-[#5c6b8a]  group-hover:text-white"></i>
                        </div>
