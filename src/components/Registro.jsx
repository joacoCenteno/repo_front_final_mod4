    ...
    <>
        ...
        <form action="post" onSubmit={handleSubmit(onSubmit)} className={` z-50 flex flex-col gap-4 bg-[#171e2d] text-[#42c1fc] shadow-xl p-6 rounded-2xl w-full max-w-md mx-auto ${!isDark&&"text-[#4e5c77] bg-[#eceeff]"}
            ...
            <button type="submit" disabled={isSubmitting || waiting} className={`mt-2 w-full bg-[#42c1fc] text-white font-semibold py-2 rounded-xl
               hover:bg-[#1e88e5] transition-all shadow-md hover:shadow-lg ${!isDark&&"text-[#4e5c77]  bg-[#b9c0ff] hover:bg-[#959fff]"}  ${isSubmitting || waiting ? 'opacity-30' : ''} cursor-pointer`}>Registrarme</button>
        </form>
